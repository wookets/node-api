...
describe('api.validate()', function() {
  ...
  it('should invoke with bad auth', function(done) {
    ...
    api.invoke('/invoke/me', {params: params}, function(err, result) {
  ...
  it('should invoke with bad params', function(done) {
    ...
    api.invoke('/invoke/me', {user: user}, function(err, result) {
  ...
  it('should invoke with good params', function(done) {
    ...
    api.invoke('/invoke/me', {params: params, user: user}, function(err, result) {
